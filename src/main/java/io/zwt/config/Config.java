...
public class Config {
  ...
  public static final InetSocketAddress GATEWAY = new InetSocketAddress(GATEWAY_ADDRESS, PORT);
  public static final InetSocketAddress GATEWAY_UDP = new InetSocketAddress(MULTICAST_ADDRESS, UDP_PORT);
}
